...
import { AgenciesLeadsComponent } from './agencies-leads.component';
...
const routes: Routes = [{ path: '', component: AgenciesLeadsComponent }];

@NgModule({
  declarations: [AgenciesLeadsComponent],
  imports: [
    TranslateModule,
    CommonModule,
...
export class AgenciesLeadsModule {}
